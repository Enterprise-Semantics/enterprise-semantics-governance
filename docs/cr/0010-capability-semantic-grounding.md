...
This CR was promoted from Proposed to Accepted on 2026-09-23 per user directive message 1552262422398767115 (*Proceed with everything*). The promotion ritual per ADR-ES-001 §10-§11 (body Status field + this §29 Acceptance section, with the cardinal author footer preserved) was executed in concert with the ADR-ES-002 promotion.

The promotion to Accepted has the following consequences:

* All 12 acceptance criteria of §26 are satisfied.
...
* Documentation per §19: docs/concepts/capability.md + docs/architecture/capability-boundary.md + docs/relationships/capability-relationships.md.
...
* No WSF modification has been made (per FND-ES-AG-008 §1.3).
