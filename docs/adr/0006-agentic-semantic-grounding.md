...
Related: CR-ES-004 (Agentic Semantic Grounding, Proposed) ;; ADR-ES-005 (Agentic Value Stream, future) ;; ADR-ES-006 (Agentic Workflow, future) ;; ADR-ES-007 (Autonomous Operations, future) ;; FND-ES-AG-001-Grounding-Result §1 (kernel/decomposition pattern)
